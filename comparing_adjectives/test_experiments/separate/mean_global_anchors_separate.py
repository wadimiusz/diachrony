...
for word in words:
    ...
    scores1.append(1 - ga_score1)
    ga_score2 = GlobalAnchors(w2v1=model2_aligned2, w2v2=model3_aligned).get_score(word)
    scores2.append(1 - ga_score2)
...
#results.to_csv('globalanchors_eval_separated.csv', encoding='utf8')
results.to_csv('globalanchors_rest_separated.csv', encoding='utf8')
