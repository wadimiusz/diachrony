...
results['mean_dist'] = mean_ga
results['mean_freq'] = mean_freqs
#results.to_csv('globalanchors_eval_incremental.csv', encoding='utf8')
results.to_csv('globalanchors_rest_incremental.csv', encoding='utf8')
